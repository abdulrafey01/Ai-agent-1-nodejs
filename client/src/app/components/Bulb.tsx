...
const Bulb = ({ className, brightness, temperature }: Props) => {
  return (
    <svg
      className={className}
      //   width="800px"
    ...
    >
      ...
      {/* The more the height of this rect, the more the gray part shows. It shows full on 90. It means i want to do full brightness, it goes full dull */}
      <defs>
        <clipPath id="cut-top">
          <rect
            x="0"
      ...
      {/* First path to give black border */}
      <path
        ...
        fill={temperatureColors[temperature]}
        strokeWidth={1}
        stroke="black"
        className="transition-all ease-in-out duration-2000"
      ></path>
      <path
        d="M64 4C42.92 4 25.82 19.67 25.82 38.99c0 5.04 1.52 10.43 3.75 15.18c3.13 6.68 6.54 11.62 7.54 13.44c2.78 5.06 2.38 10.39 3.15 13.73c1.45 6.24 5.79 8.5 23.73 8.5s21.8-2.15 23.41-7.9c1.1-3.91.03-8.18 2.8-13.23c1-1.82 5.07-7.85 8.21-14.54c2.23-4.75 3.75-10.14 3.75-15.18C102.18 19.67 85.08 4 64 4z"
        fill="gray"
